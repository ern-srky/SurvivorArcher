...
OYUNUN AÇIKLAMASI
  ...
  Oyunun temel amacı,
bir harita üzerinde dalgalar halinde gelen düşmanlara karşı hayatta kalmak,
  
  Düşmanlar öldükçe düşen deneyim küreleri (XP) toplandığında seviye
atlanmakta ve her seviye yeni bir gelişim fırsatı sunmaktadır.
  
  Oyuncu, fare ve klavye kombinasyonunu kullanarak karakterini 360 derece kontrol edebilmektedir(WASD). 
  
  Ok ve Yay: Fare ile nişan alınır ve fırlatılır. Oklar, yerçekimi ve hız vektörlerine sahip dinamik
objelerdir.
